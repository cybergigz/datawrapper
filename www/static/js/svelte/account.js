	...
	function create_pending_block$1(component, ctx) {
		...
		return {
			c: function create() {
				...
				i.className = "fa fa-spinner fa-spin";
				addLoc(i, file$5, 68, 16, 2944);
				div.className = "text-error";
				addLoc(div, file$5, 70, 16, 3023);
			},
	...
	function create_if_block_2$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(button, file$5, 79, 16, 3385);
			},
	...
	function create_if_block_1$4(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(button, file$5, 77, 16, 3246);
			},
